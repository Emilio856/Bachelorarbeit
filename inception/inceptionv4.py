# This program trains an Inception v4 architecture to measure the length
...
run_id = datetime.now().strftime("Inception V4 %Y_%m_%d T %H-%M-%S")
...
def make_model():
    """
    Creates an Inception v4 model and compiles it with the Adam algorithm
...
model.save(os.path.join(logdir, "Inception V4"))
