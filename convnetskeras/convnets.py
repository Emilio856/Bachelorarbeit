# Updated code to tensorflow 2 and keras 2
...
def AlexNet(weights_path=None, heatmap=False):
    ...
    conv_1 = Conv2D(96, 11, 4, activation='relu',
                           name='conv_1')(inputs)

    conv_2 = MaxPooling2D((3, 3), strides=(2, 2))(conv_1)
    conv_2 = crosschannelnormalization(name='convpool_1')(conv_2)
    conv_2 = ZeroPadding2D((2, 2))(conv_2)
    conv_2 = tf.keras.layers.Concatenate([Conv2D(128, 5, 5, activation='relu', name='conv_2_' + str(i + 1))(
