...
run_id = datetime.now().strftime("EffNetB3 %Y_%m_%d T %H-%M-%S")
...
def make_model():
    base_b1 = tf.keras.applications.EfficientNetB3(input_shape=(450, 450, 3),
...
model.save(os.path.join(logdir, "EffNetB3"))
