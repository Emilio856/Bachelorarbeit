# This program trains an EfficientNet B0 architecture to measure the length
...
run_id = datetime.now().strftime("EffNetB0 %Y_%m_%d T %H-%M-%S")
...
def make_model():
    """
    Creates an EfficientNet B0 model and compiles it with the Adam algorithm
    and the Mean Squared Error.

    Returns:
      An EfficientNet B0 model.
    """
    base_b1 = tf.keras.applications.EfficientNetB0(input_shape=(450, 450, 3),
...
model.save(os.path.join(logdir, "EffNetB0"))
