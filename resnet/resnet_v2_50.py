# This program trains a ResNet50V2 architecture to measure the length
...
run_id = datetime.now().strftime("ResNetV2 50 %Y_%m_%d T %H-%M-%S")
...
def make_model():
    """
    Creates a ResNet50V2 model and compiles it with the Adam algorithm
    and the Mean Squared Error.

    Returns:
      A ResNet50V2 model.
    """
    base_resnet = tf.keras.applications.ResNet50V2(input_shape=(450, 450, 3),
...
model.save(os.path.join(logdir, "ResNetV2 50"))
